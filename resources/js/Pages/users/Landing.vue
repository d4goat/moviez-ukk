        ...
        <TransitionRoot appear :show="!isLoading && !isLoadingFilm" as="div">
            <div class="flex flex-col gap-5 py-4">
              <div class="flex relative">
                ...
                <TransitionChild
                  as="div"
                  enter="transform transition-all duration-1000 ease-out delay-300"
                  enter-from="opacity-0 translate-y-12 scale-90"
                ...
                >
                  <div class="flex flex-col items-center space-y-4">
                    <TransitionChild
                      as="h1"
                      enter="transform transition-all duration-1000 ease-out"
                      ...
                      class="text-title-xl font-semibold tracking-wide"
                    >
                    ...
                    <TransitionChild
                      as="h1"
                      enter="transform transition-all duration-1000 ease-out delay-200"
                      enter-from="opacity-0 translate-y-8"
                      enter-to="opacity-100 translate-y-0"
                      leave="transform transition-all duration-300 ease-in"
                      leave-from="opacity-100 translate-y-0"
                  ...
                  <div class="flex space-x-7">
                    ...
                    <router-link :to="`/landing/film-detail/${reviews.uuid}`">
                      ...
                      <div class="text-center flex gap-3 justify-center">
                        <vue3starRatings 
                          :star-size="22" 
                          v-model="reviews.reviews_avg_rating" 
                          :disable-click="true"
                          star-color="#ffea06" 
